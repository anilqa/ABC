 ...
 */
public class Scenario3 extends Reusables implements OR_HomePage,OR_FlightDetails,OR_EssentialsBaggagePreference {

    LinkedHashMap<String,String> testData= new LinkedHashMap<String,String>();
    @org.testng.annotations.Test
    public void scenario3() throws Throwable {
        logger=extent.startTest("Started Scenario3 (RoundTrip)");
        ...
        waitForElementToBeClickable(continueBtn_Gen,30);
        click(continueBtn_Gen);
        popUpHandler();
        waitForElementToBeClickable(bookSportsEqpBtn);
        click(bookSportsEqpBtn);
